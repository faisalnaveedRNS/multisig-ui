...
ARG  NEXT_PUBLIC_SUPPORTED_DENOM
ARG  NEXT_PUBLIC_SUPPORTED_DENOM_DISPLAY
...
ENV  NEXT_PUBLIC_SUPPORTED_DENOM ${NEXT_PUBLIC_SUPPORTED_DENOM}
ENV  NEXT_PUBLIC_SUPPORTED_DENOM_DISPLAY ${NEXT_PUBLIC_SUPPORTED_DENOM_DISPLAY}
