...
export const environment = object()
  .shape({
    ...
    chainid: string().stripEmptyString().default('pylons-testnet-1'),
    chainname: string().stripEmptyString().default('Pylons'),
    rpc: string().stripEmptyString().default('http://localhost:26656'),
    rest: string().stripEmptyString().default('http://localhost:26657/'),
